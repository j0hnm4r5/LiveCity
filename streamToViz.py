...
boston = ("-71.3,42.2,-70.9,42.5", 4000, "Boston, MA")
northeast_usa = ("-80.6,38.2,-66.4,47.6", 75, "Northeastern USA")
new_york = ("-80,40.2,-71.3,46", 125, "New York State")
...
def setup():
	...
	print "Window Size: %s x %s" % (genWidth, genHeight)
